...
from bokeh.layouts import column, row, WidgetBox, gridplot, Spacer, Box
...
def searches_tab(countries):
	...
	col_inputs = column(controls, sizing_mode='fixed', height=700, width=350, css_classes=['scrollable'])
